...
return [
    ...
    'file_suppressions' => [
        ...
        'src/Command/DebugCommand.php' => ['PhanAccessClassConstantInternal', 'PhanAccessMethodInternal', 'PhanDeprecatedFunction', 'PhanParamSignatureMismatch', 'PhanRedefinedClassReference', 'PhanRedefinedExtendedClass'],
        'src/Command/SesSendTestEmailsCommand.php' => ['PhanRedefinedClassReference', 'PhanRedefinedExtendedClass'],
        'src/Controller/EndpointController.php' => ['PhanUnreferencedPublicMethod'],
        ...
        'src/Processor/NotificationProcessor.php' => ['PhanAccessMethodInternal'],
        'src/Processor/SubscriptionProcessor.php' => ['PhanAccessMethodInternal'],
        ...
        'tests/Processor/NotificationProcessorTest.php' => ['PhanTypeMismatchArgument', 'PhanTypeMismatchArgumentReal', 'PhanUnreferencedPublicMethod'],
        ...
        'tests/Processor/SubscriptionProcessorTest.php' => ['PhanTypeMismatchArgument', 'PhanTypeMismatchArgumentProbablyReal', 'PhanTypeMismatchArgumentReal', 'PhanUnreferencedPublicMethod'],
